...
export const REVIEWS: Review[] = [
  {
    ...
    rating: 5,
    text: "Fiz o Ultraformer MPT na clínica e o resultado na minha papada foi inacreditável! Parecia que eu tinha feito uma mini lipo, mas sem corte nenhum. A clínica é linda, atendimento digno de hotel 5 estrelas. Super recomendo!",
  ...
  },
  {
    ...
    rating: 5,
    text: "Depois que emagreci rápido fiz o Protocolo Pós-Mounjaro e ajudou muito a recuperar o tônus do abdômen e do bumbum. A Dra. Ellen é super atenciosa, explica tudo com calma e faz um planejamento perfeito pra nossa realidade.",
...
export const FAQS = [
  {
    ...
    a: "Em nossa clínica, toda jornada começa com uma Avaliação Integrativa detalhada feita pessoalmente por nossa equipe médica especializada. Analisamos seu histórico, grau de flacidez, qualidade de pele e seus objetivos de forma personalizada, recomendando soluções sob medida."
  },
  {
  ...
  },
  {
    ...
    a: "Nossa clínica de alto padrão está localizada na R: São Vicente de Paula, 300 centro - Itapetininga - CEP 18200280. Nosso horário de funcionamento é de segunda à sexta das 9hrs às 11hrs / 14hrs às 20hrs, e aos sábados das 8hrs às 13hrs."
  }
];
