...
export default function ClientDirectory({ 
  ...
  const handleSendWhatsAppClient = (client: Client) => {
    ...
    const defaultTemplate = `Olá ${client.name}! Passando para acompanhar seus tratamentos e agendamentos em nossa clínica de estética. Como você está se sentindo após as últimas sessões?`;
