          ...
          <div className="lg:col-span-4 space-y-8 flex flex-col justify-between">
            <div className="space-y-6">
              ...
              <p className="text-xs text-neutral-muted font-light leading-relaxed">
                ...
                máxima higiene e privacidade absoluta.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3 text-xs">
                  ...
                  <div>
                    ...
                    <p className="font-light mt-1 text-neutral-muted">
                      Av. Paulista, 1000, Cj. 101 - Bela Vista, São Paulo - SP - CEP 01310-100
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3 text-xs">
                  ...
                  <div>
                    ...
                    <p className="font-semibold mt-1 text-primary">
                      (11) 99999-9999 (Central de Atendimento)
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3 text-xs">
                  ...
                  <div>
                    ...
                    <p className="font-light mt-1 text-neutral-muted">
                      contato@clinicaesteticasaas.com.br
                    </p>
                  </div>
                </div>
            ...
            <div className="relative w-full aspect-[16/10] border border-primary/10 rounded-md overflow-hidden bg-bg-luxe flex flex-col justify-center items-center text-center p-6 shadow-md">
              ...
              <p className="text-[10px] text-neutral-muted mt-1 max-w-xs font-light">
                Endereço comercial modelo, estacionamento coberto com serviço de manobrista no local.
              </p>
              <a
                href="https://www.google.com/maps/search/?api=1&query=Rua+S%C3%A3o+Vicente+de+Paula%2C+300+Centro+-+Itapetininga+-+CEP+18200280"
                target="_blank"
              ...
              {submitted ? (
                <div className="text-center py-12 space-y-6 animate-fade-in">
                  ...
                  <div className="pt-4 space-y-2">
                    ...
                    <a
                      href={`https://wa.me/5511999999999?text=${encodeURIComponent("Olá! Enviei meus dados no formulário estético e gostaria de antecipar o retorno da minha consulta VIP.")}`}
                      target="_blank"
                      rel="noopener noreferrer"
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                    ...
                    <a
                      href={`https://wa.me/5511999999999?text=${encodeURIComponent("Olá! Gostaria de falar com o atendimento sobre agendamentos.")}`}
                      target="_blank"
                      rel="noopener noreferrer"
