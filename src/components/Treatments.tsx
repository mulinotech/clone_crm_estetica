            ...
            return (
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col justify-between">
                  ...
                  <div className="mt-6 pt-4 border-t border-primary/10 flex items-center justify-between text-[11px] text-neutral-muted">
                    ...
                    <button
                      ...
                      className="text-[11px] uppercase tracking-wider text-primary font-semibold group-hover:text-primary-light transition-colors cursor-pointer"
                    >
                      Ver Detalhes →
                    </button>
                  </div>
            ...
            <div className="p-6 md:p-8 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 pt-4 justify-between">
                <span className="text-neutral-muted text-[11px] max-w-sm text-center sm:text-left">
                  *Necessário passar por avaliação com nossa equipe para personalização definitiva.
                </span>
                <div className="flex space-x-3 w-full sm:w-auto">
                  ...
                  <a
                    href={`https://wa.me/5511999999999?text=${encodeURIComponent(`Olá! Gostaria de tirar dúvidas e saber valores para o tratamento de ${activeModal.name}.`)}`}
                    target="_blank"
