...
import { Sparkles, MessageSquare, Users, Calendar, Settings, LayoutDashboard, X, MessageCircle } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row justify-between md:h-20 items-stretch md:items-center gap-3 py-3 md:py-0 min-w-0">
          ...
          <div className="flex items-center justify-between w-full md:w-auto">
            ...
            <div className="flex items-center space-x-3">
              <div className="bg-brand-brown text-brand-beige p-2.5 rounded-full shadow-inner flex items-center justify-center shrink-0">
