          ...
          <div className="lg:col-span-7 flex flex-col space-y-6 text-left">
            ...
            <div className="inline-flex items-center space-x-2 bg-luxury-gray/80 border border-primary/15 px-3.5 py-1.5 rounded-full w-fit">
              ...
              <span className="text-[10px] tracking-[0.2em] font-semibold uppercase text-primary">
                Lançamento Exclusivo em Itapetininga
              </span>
            </div>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-serif tracking-tight text-neutral leading-[1.1]">
              ...
              nasce do <span className="text-gold-gradient font-medium italic">cuidado</span>
            </h1>
            ...
            <p className="text-neutral-muted text-sm sm:text-base md:text-lg font-light leading-relaxed max-w-2xl">
              Clínica de estética de alto padrão pioneira na região com tecnologias extraordinárias como
              ...
              Sob coordenação técnica de nossa <span className="text-neutral font-medium">Equipe Médica Especializada</span>, 
              entregamos recondicionamento facial e rejuvenescimento corporal com naturalidade, sofisticação e conforto absoluto.
            </p>
