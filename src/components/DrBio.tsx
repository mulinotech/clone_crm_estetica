...
import draNathali from "../assets/dra_nathali.png";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="relative w-full max-w-[380px] aspect-[4/5] rounded bg-white p-2 border border-primary/10 shadow-lg">
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-md border border-primary/10 px-4 py-3 rounded text-center shadow-lg">
                ...
                <p className="text-[9px] text-neutral-muted mt-0.5 tracking-wider font-light">
                  Especialista em Estética Avançada • Registro CRM/Estética Ativo
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-6 flex flex-col justify-center">
            ...
            <div className="space-y-4 text-xs sm:text-sm text-neutral-muted font-light leading-relaxed">
              <p>
                Em nossa clínica de estética avançada, nossa{" "}
                <strong className="text-primary font-medium">Equipe Médica Especializada</strong> é
                dedicada a redefinir os parâmetros de autocuidado.
                Com sólida formação acadêmica em harmonia facial e cosmetologia avançada, idealizamos uma
                clínica diferenciada onde cada paciente recebe atenção VIP e protocolos exclusivos baseados em tecnologias de última geração.
              </p>
              <p>
                Acreditando que o autocuidado é a base do bem-estar, nossa equipe não trabalha com resultados caricatos
            ...
            <div className="pt-6">
              <a
                href={`https://wa.me/5511999999999?text=${encodeURIComponent("Olá! Gostaria de agendar uma consulta de avaliação com a equipe médica.")}`}
                target="_blank"
              ...
              >
                <span>Falar com o Atendimento Médico</span>
