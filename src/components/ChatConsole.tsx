  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch h-[calc(100vh-140px)]">
      ...
      <div className="lg:col-span-4 bg-white rounded-2xl border border-brand-gold/15 p-5 shadow-xs flex flex-col h-full overflow-hidden">
        <div className="pb-4 mb-4 border-b border-brand-beige">
        ...
        <div className="flex-1 overflow-y-auto space-y-2.5 pr-1">
          {contacts.map((contact) => {
            ...
            const lastMsg = interactions
              .filter(i => i.clientId === contact.id)
              ...
              <div key={contact.id} className="relative group w-full">
                ...
                >
                  <div className="flex justify-between items-center w-full mb-1">
                    <span className="text-xs font-serif font-semibold">{contact.name}</span>
                  ...
                  {lastMsg && (
                    <p className={`text-xxs truncate mt-2 leading-relaxed w-full ${isSelected ? 'text-brand-beige/70' : 'text-brand-brown/55'}`}>
