      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-neutral-muted text-xs sm:text-sm font-light mt-5 leading-relaxed">
            Abaixo, explore casos representativos que refletem nossa filosofia médica:
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="pt-2">
              <a
                href={`https://wa.me/5511999999999?text=${encodeURIComponent(`Olá! Gostaria de conversar sobre o tratamento de ${activeItem.title}.`)}`}
                target="_blank"
